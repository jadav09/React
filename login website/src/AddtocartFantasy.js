...
let num = 1
function AddtocartFantasy() {

    let [qun, setqun] = useState(num)

    let { fantsy } = useParams("")
    console.log(fantsy)

    let [fantasy, setfantasy] = useState("")

    useEffect(() => {
        fetch("http://localhost:4005/fantasy/" + fantsy)
                    ...
                    <div className="col-sm-6 row">
                        ...
                        <div className="card  col-6 text-start">
                            <div className="card-body">
                                <img src={fantasy.url} alt="" className='w-100' />
                                <h5 className=''> ${fantasy.price}</h5>
                                ...
                                <h4 className="card-title text-success">{fantasy.name}</h4>
                            </div>
...
export default AddtocartFantasy