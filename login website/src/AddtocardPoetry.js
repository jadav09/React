...
function AddtocardPoetry() {
    ...
    useEffect(() => {
        fetch("http://localhost:4008/poetry/" + poid)
                    ...
                    <div className="col-sm-6 row">
                        ...
                        <div className="card  col-6 text-start">
                            <div className="card-body">
                                <img src={poetry.url} alt="" className='w-100' />
                                <h5 className=''> ${poetry.price}</h5>
                                ...
                                <h4 className="card-title text-success">{poetry.name}</h4>
                            </div>
...
export default AddtocardPoetry